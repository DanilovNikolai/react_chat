...
function Chat() {
   ...
   return (
      <Container>
         <Grid container style={{height: window.innerHeight - 50, justifyContent: "center", alignItems: "center", marginTop: '10px'}}>
            <div style={{width: '80%', height: '70vh', border: '1px solid rgb(152, 61, 152)', borderRadius: "10px", overflowY: 'auto'}}>
               {messages.map(message =>
                  ...
                  style={{
                     ...
                     <Grid container>
                        <Avatar style={{borderRadius: '5px', margin: '5px'}} src={message.photoURL}/>
                        <div style={{margin: 'auto', fontFamily: 'Segoe UI', fontWeight: '700'}}>{message.displayName}</div>
                     </Grid>
                     <div style={{color: '#000', fontFamily: 'Segoe UI'}}>{message.text}</div>
                  </div>
               )}
            </div>
